WSO2 Business Activity Monitor, v2.4.0
================================

25th October 2013

Welcome to the WSO2 Business Activity Monitor, v2.4.0 release
...
Incremental Processing for Cassandra/Hive.

Annotation scheme for Hive scripts.

API for sending BAM message tracing details.

Web filter to send message tracer information.

Added Timestamp data type support to Cassandra data handler.

Creating secondary and custom indexes for defined indexed properties and indexing data.

Searching support on defined indexed properties.

Cassandra stream filter has been implemented in pure XML.

Sending Notifications from Hive.


Improvements
============

Updated to Jaggery 0.9.0 Alpha4.

Cassandra archive data deploys a hive script which does not use cassandra datasource.

Corrected the link to BAM Toolbox documentation.

Removed BAM 1.x components.

Storing data to Cassandra via Input Transport Handlers.

Removed Carbon.core.common from thrift agent.

Improved Activity ID Propagation in Activity Datapublisher.

BAM Analyzer Cluster Coordination Using Hazelcast.

Improved BAM Toolbox by providing the ability to define secondary and custom index properties(of a stream) in toolboxes.

Reimplemented the message tracing in Activity Monitoring Toolbox.

Improved drilling down of activities in the UI in Activity Monitoring Toolbox.

Deleted datareceiver.war file from data bridge's REST data receiver source directory.

Added Cassandra Datasink stream filter.

Removed the old activity monitoring components from the service statistics data agent.

Cleaned up BAM toolboxes.

Created cassandra profile for BAM.

Created BAM message tracer agent.
...
============================
* WSO2 Business Activity Monitor related components of the WSO2 Carbon Platform - https://wso2.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=11580

Known Issues in This Release
============================

All known issues have been recorded at https://wso2.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=11579
...
======================================================
    ...
    - release-notes.html
      Release information for WSO2 Business Activity Monitor 2.4.0
